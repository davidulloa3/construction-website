...
const transformations = [
  {
    label: "Kitchen",
    beforeSrc: "/images/gallery-9.jpg",
  ...
  {
    label: "Bathroom",
    beforeSrc: "/images/gallery-4.jpg",
    afterSrc: "/images/gallery-3.jpg",
    beforeAlt: "Dated bathroom before renovation by Ulloa Construction in Orange County CA",
    afterAlt: "Spa-style bathroom renovation completed by Ulloa Construction in Anaheim CA",
  },
  {
    label: "Interior",
    beforeSrc: "/images/gallery-5.jpg",
    afterSrc: "/images/gallery-7.jpg",
