    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pt-40 text-center">
        <div className="animate-fade-in-up">
          <p className="inline-flex items-center gap-2 text-[#1e88e5] text-sm font-semibold tracking-widest uppercase mb-6 bg-[#1565c0]/10 border border-[#1565c0]/20 px-4 py-1.5 rounded-full">
