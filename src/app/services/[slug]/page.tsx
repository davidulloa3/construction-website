    ...
    <div className="pt-16">
      ...
      >
        ...
        <img
          ...
          alt={`${service.name} project in Anaheim and Orange County CA by Ulloa Construction`}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          >
            {service.name} in Anaheim
            <br />
            <span className="text-amber-400">&amp; Orange County</span>
          </h1>
      ...
      <section className="py-16 bg-[#1a1a1a]" aria-labelledby="included-heading">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            id="included-heading"
            className="text-3xl font-black text-[#f5f5f5] mb-8"
          >
            What&apos;s Included in Our{" "}
            <span className="text-amber-500">{service.name} Service</span>
          </h2>
      ...
      <section className="py-16 bg-[#0f0f0f]" aria-labelledby="ba-heading">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#a0a0a0] text-center mb-10">
            Drag the slider to compare — real work by our crew in Orange County.
          </p>
          <BeforeAfterSlider
            beforeSrc={service.beforeImage}
            afterSrc={service.afterImage}
            beforeAlt={`Before ${service.name} — dated space in Anaheim CA before Ulloa Construction`}
            afterAlt={`After ${service.name} — finished result by Ulloa Construction in Orange County CA`}
          />
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {valueCards.map((card) => (
              <div
                key={card.title}
                className="bg-[#0f0f0f] rounded-2xl p-6 border border-[#2a2a2a] text-center"
              >
      ...
      <section className="py-16 bg-[#0f0f0f]" aria-labelledby="related-heading">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            id="related-heading"
            className="text-2xl font-black text-[#f5f5f5] mb-8 text-center"
          >
            Related Services
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {related.map((rel) => (
              <Link
                ...
                className="bg-[#1a1a1a] border border-[#2a2a2a] hover:border-amber-500 rounded-xl p-6 group transition-all hover:shadow-[0_0_20px_rgba(192,57,43,0.15)]"
              >
                <h3 className="font-bold text-[#f5f5f5] group-hover:text-amber-400 transition-colors mb-2">
                  {rel.name}
                </h3>
